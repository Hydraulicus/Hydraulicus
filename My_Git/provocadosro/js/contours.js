...
,intoClone = [
  ...
  ,'<polyline fill="rgba(255,255,255, 0.01)" id="arrowright" fill-rule="nonzero" stroke="white" stroke-width="3" points="568,236 590,272 568,309 "/>'
  ,'<polyline fill="rgba(255,255,255, 0.01)" id="arrowleft" fill-rule="nonzero" stroke="white" stroke-width="3" points="51,309 29,273 51,236 "/>'
  ,'<polygon id="closecross" fill="white" fill-rule="nonzero" stroke-width="10" stroke="rgba(255,255,255, 0.01)" points="446,28 439,20 443,16 451,24 458,16 463,21 455,28 463,36 458,40 451,32 443,40 439,36 "/>'
]
